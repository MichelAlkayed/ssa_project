...
urlpatterns = [
   ...
   path('group//create_event/', views.create_event, name='create_event'), 
   path('group//event//join/', views.join_event, name='join_event'), 
   path('group//event//update_status/', views.update_event_status, name='update_event_status'), 
   path('group//event//leave/', views.leave_event, name='leave_event'), 
   path('group//event//delete/', views.delete_event, name='delete_event'), 
